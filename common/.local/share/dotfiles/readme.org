...
**** Document
  #+ATTR_LATEX: :environment longtable :align |l|p{5cm}|p{8cm}|
   ...
   | [[https://packages.gentoo.org/packages/app-editors/emacs][app-editors/emacs]]              | xpm xft tiff svg m17n-lib lcms gpm gif dbus cairo acl dynamic-loading games gconf gsettings imagemagick libxml2 xwidgets | The extensible, customizable, self-documenting real-time display editor                          |
