...
#+ATTR_LATEX: :environment longtable :align |l|l|
 ...
 | ~super + shift Enter~ | /screen/ inside Terminal Emulator                       |
 | ~super + q~           | File Manager                                            |
 | ~super + shift+ u~    | Opens /htop/ inside terminal emulator                   |
 | ~super + shift + a~   | Opens /pavucontrol/ inside terminal emulator            |
 | ~super + shift + o~   | Opens $BROWSER[fn:1]                                    |
 | ~super + shift + g~   | Opens Gimp                                              |
 | ~super + shift + h~   | Opens $VISUAL[fn:2]                                     |
 | ~super + shift + n~   | Opens $ALTERNATE_EDITOR [fn:3] inside terminal emulator |
 |-----------------------+---------------------------------------------------------|
...
#+ATTR_LATEX: :environment longtable :align |l|l|
 ...
 | ~super + Scroll_Lock~       | Toggle /screenkey/                                           |
...
#+ATTR_LATEX: :environment longtable :align |l|l|
 ...
 | Keybinding                        | Description                        |
 |-----------------------------------+------------------------------------|
 | ~super + shift + m~               | Opens music player inside terminal |
...
**** Multimedia
  #+ATTR_LATEX: :environment longtable :align |l|p{5cm}|p{8cm}|
   ...
   | [[https://gpo.zugaina.org/media-tv/emby-server][media-tv/emby-server]]       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | [[https://gpo.zugaina.org/Overlays/megacoffee][megacoffee]] overlay                                                                    |
   | [[https://packages.gentoo.org/packages/media-gfx/imagemagick][media-gfx/imagemagick]]      | X bzip2 cxx jpeg jpeg2k openmp png webp zlib corefonts djvu fftw fontconfig fpx graphviz hdri heif jbig lcms lqr lzma openexr pango perl postscript raw svg tiff truetype wmf xml corefonts                                                                                                                                                                                                                                                                                                               | A collection of tools and libraries for many image formats                            |
   |----------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------|
**** Fonts
  #+ATTR_LATEX: :environment longtable :align |l|l|p{8cm}|
   |-------------------------+-----------+-----------------------------------------------------------------------|
...
**** System
  #+ATTR_LATEX: :environment longtable :align |l|p{5cm}|p{8cm}|
   ...
   | [[https://gpo.zugaina.org/app-crypt/keybase-bin][app-crypt/keybase-bin]]              |                                                                                                                            | Client for keybase.io, [[https://gpo.zugaina.org/Overlays/dmchurch][dmchurch]] overlay                                     |
   ...
   | [[https://packages.gentoo.org/packages/dev-libs/geoip][dev-libs/geoip]]                     |                                                                                                                            | GeoIP Legacy C API                                                          |
   | [[https://packages.gentoo.org/packages/dev-python/geoip-python][dev-python/geoip-python]]            |                                                                                                                            | Python bindings for GeoIP                                                   |
   | [[https://packages.gentoo.org/packages/net-misc/geoipupdate][net-misc/geoipupdate]]               |                                                                                                                            | performs automatic updates of GeoIP2 and GeoIP Legacy binary databases      |
   | [[https://gpo.zugaina.org/dev-dotnet/referenceassemblies-pcl][dev-dotnet/referenceassemblies-pcl]] |                                                                                                                            | dotnet overlay, dependency for media-tv/emby-server                         |
   |------------------------------------+----------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------|
